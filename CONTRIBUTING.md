# Contributing to Jobplacement-enterprice Backend
...
- Make sure you created an [Issue](https://github.com/Platzi-Master-C8/JP-Enterprise-backend/issues) related to it and you're following the [issues section](#Issues) recommendations
